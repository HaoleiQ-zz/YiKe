 ...
 */
public class shaoyou_dataBase2 extends SQLiteOpenHelper {
    private static final String tag = "DBSQLiteHelper";
    private static final String name = "shaoyou_data2";
    ...
    public static final String CREATE_BOOK = "create table shaoyou_data2 ("
    ...
    public shaoyou_dataBase2(Context context) {
        super(context, name, null, version);
        Log.d("shaoyou", "我的数据库构造器");

    }

    public shaoyou_dataBase2(Context context, String name, SQLiteDatabase.CursorFactory factory, int version) {
        super(context, name, factory, version);

        mContext = context;
    }

    public shaoyou_dataBase2(Context context, String name, SQLiteDatabase.CursorFactory factory, int version, DatabaseErrorHandler errorHandler) {
