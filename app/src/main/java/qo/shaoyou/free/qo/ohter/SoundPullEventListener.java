...
import qo.shaoyou.free.qo.ohter.PullToRefreshBase;
import qo.shaoyou.free.qo.ohter.PullToRefreshBase.Mode;
import qo.shaoyou.free.qo.ohter.PullToRefreshBase.State;
...
public class SoundPullEventListener<V extends View> implements PullToRefreshBase.OnPullEventListener<V> {
    ...
    @Override
    public final void onPullEvent(PullToRefreshBase<V> refreshView, PullToRefreshBase.State event, Mode direction) {
